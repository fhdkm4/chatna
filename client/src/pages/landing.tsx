  ...
  return (
    <div className="landing-root" dir="rtl">
      <style>{`
        ...
        .l-logo img,.l-logo .logo{height:64px;width:auto;object-fit:contain;background:transparent}
      ...
      <nav ref={navRef} className="l-nav" data-testid="landing-nav">
        <div className="nav-in">
          <a href="/landing" className="l-logo" data-testid="text-brand-logo" style={{ display: "flex", alignItems: "center" }}><ChatnaLogo height={64} /></a>
          <div className="nav-r">
