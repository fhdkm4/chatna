          ...
          {steps.map((step, i) => (
            <div key={step.id} className="flex items-center">
              <div className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-colors ${
                ...
                currentStep > step.id ? "bg-emerald-500/10 text-emerald-500" : "bg-white/5 text-gray-500"
              }`}>
                <div className={`w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold ${
                  currentStep > step.id ? "bg-emerald-500 text-white" :
                  currentStep === step.id ? "bg-emerald-500/30 text-emerald-400" : "bg-white/10 text-gray-500"
                }`}>
          ...
          {currentStep === 2 && (
            <div className="space-y-6">
              ...
              <div className="flex justify-between mt-6">
                ...
                <Button className="bg-emerald-600 text-white" onClick={handleSaveAi} disabled={loading}>
          ...
          {currentStep === 3 && (
            <div className="space-y-6">
              ...
              <div className="flex gap-3">
                ...
                <Button data-testid="button-wizard-send-invite" className="bg-emerald-600 text-white" onClick={handleInvite} disabled={loading || !inviteEmail}>
                ...
                <div className="space-y-2 mt-4">
                  ...
                  {invitations.map((inv, i) => (
                    <div key={i} className="flex items-center justify-between p-3 rounded-lg bg-white/5 border border-white/5">
                      ...
                      <span className="text-xs text-emerald-400 bg-emerald-500/10 px-2 py-1 rounded">{roleLabels[inv.role]}</span>
                    </div>
                  ))}
                </div>
              )}
              ...
              <div className="flex justify-between mt-6">
                ...
                <Button className="bg-emerald-600 text-white" onClick={handleFinish} disabled={loading}>
