            ...
            <>
              <div className="mb-6 p-4 rounded-lg bg-emerald-500/5 border border-emerald-500/10">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-emerald-400 font-medium text-sm">دعوة صالحة</span>
                </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <Button type="submit" disabled={loading} data-testid="button-accept-invitation" className="w-full bg-emerald-600 text-white font-medium py-2.5 mt-2">
