...
export const tenants = pgTable("tenants", {
  ...
  maxOpenConversationsPerUser: integer("max_open_conversations_per_user").default(5),
  ...
  aiTone: varchar("ai_tone", { length: 20 }).default("friendly"),
...
export const contacts = pgTable("contacts", {
  ...
  optInSource: varchar("opt_in_source", { length: 30 }),
